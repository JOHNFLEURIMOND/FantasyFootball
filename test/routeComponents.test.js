...
const player = {
  ...
  DataLabel: 'Observed statistics',
  Season: '2025',
  Week: 1,
};

const game = {
  GameKey: '2025_01_NE_NYJ',
  AwayTeam: 'NE',
  HomeTeam: 'NYJ',
  ...
  DateTime: '2025-09-07T17:00:00.000Z',
  Status: 'scheduled',
  Week: 1,
  Season: '2025',
  AwayScore: null,
...
for (const [name, overrides, expected] of statsCases) {
  test(`Weekly Projections renders ${name} state`, () => {
    const html = renderWithContext(
      StatsContext,
      statsValue({ ...overrides, dataKind: 'estimated' }),
      WeeklyProjections
    );
...
const scheduleCases = [
  ...
  ['partial', { partial: true }, /Some schedule records are unavailable/],
