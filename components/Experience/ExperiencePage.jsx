            ...
            {card ? (
              <Card>
                ...
                >
                  ...
                  <YoutubeCardContent aria-label='description'>
                    As I continue to grow in as an Engineer, I would also love to grow in the Back End development so I
                    can be more proficient become better being a Full-stack Developer. I have experience with relational
                    and non-relational databases using promgramming langanuages, Node & Express to develop CRUD
                    applications.
                  </YoutubeCardContent>
                </CardBody>
              </Card>
              ...
              <Card>
                <CardBody onClick={() => flipCard(true)}>
                  ...
                  <YoutubeCardContent aria-label='description'>
                    I do my best to embower the designer and prevent techinical constrants from composing user
                    experince. Developing a simple single static to a complex web-based internet applications with
                    responsive resuable components. Leverage developer workflow tools such as Jenkins, Docker, Git,
